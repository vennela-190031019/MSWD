...
const App = (props) => {
  ...
  const maxVotedAnecdote = anecdote[maxVote.idx];
  return (
    <div>
      <Heading text="Anecdote of the Day" />
      <Anecdote anecdote={anecdote[selected]} votes={votes[selected]} />
      <br />
...
ReactDOM.render(<App anecdotes={anecdote} />, document.getElementById("root"));
export default App;
